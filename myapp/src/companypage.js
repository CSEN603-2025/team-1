...
function CompanyPage() {
  ...
  const handleDeleteJob = (indexToDelete) => {
    ...
    if (companyIndex !== -1) {
      const company = companies[companyIndex]
      const updatedCompanyJobs = company.jobs.filter((job) => !(job.title === jobToDelete.title))
      const updatedCompany = {
        ...company,
  ...
  const filteredJobs = postedJobs.filter((job) => {
    ...
    const matchesDuration = selectedDurations.length === 0 || selectedDurations.includes(job.duration)
            ...
            <div>
              ...
              {filteredJobs.length > 0 ? (
                      ...
                      <tbody>
                        {filteredJobs.map((job, index) => (
                          <tr
                            ...
                            style={{
                              borderBottom:
                                index < filteredJobs.length - 1 ? `1px solid ${theme.neutral.light}` : "none",
                              transition: "background-color 0.2s",
                            }}
                          >
                            <td
                            ...
                            >
                              ...
                              >
                                ...
                                <button onClick={() => handleDeleteJob(index)} style={buttonStyle.danger}>
                                  <svg
                                    width="14"
                                    height="14"
                                    viewBox="0 0 24 24"
                ...
                >
                  ...
                  <button onClick={handleJobModalToggle} style={buttonStyle.primary}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      ...
                      <tbody>
                        {filteredApplicants.map((applicant, index) => (
                          <tr
                            ...
                            style={{
                              borderBottom:
                                index < filteredApplicants.length - 1 ? `1px solid ${theme.neutral.light}` : "none",
                              transition: "background-color 0.2s",
                            }}
                          >
                            <td
