    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {isSCAD ? "SCAD Evaluation Reports" : "Faculty Evaluation Reports"}
          </h1>
            ...
            >
              <div
                style={{
                  ...
                  height: "36px",
                  borderRadius: "50%",
                  backgroundColor: isSCAD ? "#8b5cf6" : "#6366f1",
                  color: "#fff",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
          ...
          {!loading && (
            ...
            >
              ...
              >
                ...
                >
                  {isSCAD
                    ? "Monitor and review all student internship evaluation reports. Select a student to view their complete evaluation details."
                    : "Review detailed evaluation reports for students who have completed internships. Select a student from the list below to view their complete evaluation details."}
                </p>
              </div>
                ...
                >
                  {report.map((data, index) => (
                    <button
                      ...
                      style={{
                        padding: "12px 20px",
                        backgroundColor: expandedStudentIndex === index ? (isSCAD ? "#8b5cf6" : "#6366f1") : "#fff",
                        color: expandedStudentIndex === index ? "#fff" : "#333",
                        border: `1px solid ${
                          expandedStudentIndex === index ? (isSCAD ? "#8b5cf6" : "#6366f1") : "#e5e7eb"
                        }`,
                        borderRadius: "6px",
                        cursor: "pointer",
                        fontSize: "14px",
                        ...
                        transition: "all 0.2s",
                        boxShadow:
                          expandedStudentIndex === index
                            ? `0 2px 5px ${isSCAD ? "rgba(139, 92, 246, 0.2)" : "rgba(99, 102, 241, 0.2)"}`
                            : "none",
                      }}
                      onMouseOver={(e) => {
              ...
              {expandedStudentIndex !== null && (
                ...
                >
                  ...
                  >
                    <div
                      style={{
                        backgroundColor: isSCAD ? "#8b5cf6" : "#6366f1",
                        padding: "16px 24px",
                        borderBottom: `1px solid ${isSCAD ? "#7c3aed" : "#4f46e5"}`,
                      }}
                    >
                      <h3
                        style={{
                      ...
                      >
                        ...
                        <div
                          style={{
                            ...
                            padding: "4px 12px",
                            backgroundColor:
                              report[expandedStudentIndex].student.recommended === "Yes" ? "#dcfce7" : "#fee2e2",
                  ...
                  >
                    <div
                      style={{
                        backgroundColor: isSCAD ? "#ec4899" : "#8b5cf6",
                        padding: "16px 24px",
                        borderBottom: `1px solid ${isSCAD ? "#db2777" : "#7c3aed"}`,
                      }}
                    >
                      <h3
                        style={{
                  ...
                  >
                    <div
                      style={{
                        backgroundColor: isSCAD ? "#8b5cf6" : "#ec4899",
                        padding: "16px 24px",
                        borderBottom: `1px solid ${isSCAD ? "#7c3aed" : "#db2777"}`,
                      }}
                    >
                      <h3
                        style={{
