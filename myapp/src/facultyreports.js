...
const FacultyReport = () => {
  ...
  const saveCommentAndStatus = () => {
    ...
    if (report) {
      ...
      showNotification(`Report ${pendingStatus} successfully`, 'success');
    }
          ...
          <div style={{
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  padding: '8px 16px',
                  backgroundColor: pendingStatus === 'accepted' ? 'rgba(200, 255, 200, 0.5)' :
                                  pendingStatus === 'rejected' ? 'rgba(255, 200, 200, 0.5)' :
                                  'rgba(255, 230, 180, 0.5)',
                  color: pendingStatus === 'accepted' ? '#4a9a4a' :
                          pendingStatus === 'rejected' ? '#9a4a4a' :
                          '#9a7a4a',
                  border: 'none',
                  borderRadius: '6px',
                  cursor: 'pointer',
