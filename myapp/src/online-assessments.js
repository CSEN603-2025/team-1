  ...
  const renderScores = () => (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <h2 style={{ fontSize: '24px', fontWeight: '600', color: colors.purple.dark }}>
      ...
      {completedAssessments.length === 0 ? (
        <div style={styles.emptyState}>
          ...
          <p style={{ color: colors.gray.text }}>
            You haven't completed any assessments yet. Start one from the list!
          </p>
        </div>
      ) : (
              ...
              <tr key={index}>
                ...
                <td style={styles.tableCell}>
                  <span style={{
                    ...
                    fontSize: '12px',
                    fontWeight: '500',
                    backgroundColor: assessment.score >= 70 ? '#c6f6d5' : assessment.score >= 50 ? '#feebc8' : '#fed7d7',
        ...
        {selectedAssessment && (
          <div>
            ...
            <div style={styles.questionContainer}>
              <div style={styles.questionHeader}>
                ...
                <div style={styles.questionText}>
                  {selectedAssessment.questions[currentQuestionIndex].text}
                </div>
              </div>
              ...
              <div style={styles.optionsContainer}>
                {selectedAssessment.questions[currentQuestionIndex].options.map(option => (
                  <label 
                    ...
                    style={{
                      ...styles.optionLabel,
                      ...(answers[selectedAssessment.questions[currentQuestionIndex].id] === option.id ? styles.optionLabelSelected : {})
                    }}
                    onMouseEnter={(e) => {
                  ...
                  >
                    <input
                      ...
                      onChange={() => handleAnswerSelect(selectedAssessment.questions[currentQuestionIndex].id, option.id)}
                    />
                    {option.text}
                  </label>
                ))}
            ...
            <div style={styles.progressBar}>
              <div style={styles.progressFill((currentQuestionIndex + 1) / selectedAssessment.questions.length * 100)}></div>
            </div>
                ...
                {currentQuestionIndex < selectedAssessment.questions.length - 1 ? (
                  <button 
                    style={{
                      ...
                      cursor: answers[selectedAssessment.questions[currentQuestionIndex].id] ? 'pointer' : 'not-allowed'
                    }}
                    onMouseEnter={(e) => {
                  ...
                  <button 
                    style={{
                      ...
                      cursor: Object.keys(answers).length === selectedAssessment.questions.length ? 'pointer' : 'not-allowed'
                    }}
                    onMouseEnter={(e) => {
