...
function StudentPage() {
  ...
  const handleFileUpload = () => {
    if (pdfFile) {
      alert(`Uploaded: ${pdfFile.name}`);
      // You can add functionality to upload the file to a server or save it locally
    } else {
...
<<<<<<< HEAD
          <ul style={{ listStyleType: "none", padding: 0, marginTop: "50px" }}>
            ...
            <li>
              <a href="/jobspage">Browse Jobs</a>
            </li>
            <li>
              <a href="/past-internships">Past Internships</a>
            </li>
            <li>
...
>>>>>>> 7e13d5fb6d1fe2b95911e628ce45ef4a6b95a1a6
                Majors
              </button>
            </li>
            <li>
