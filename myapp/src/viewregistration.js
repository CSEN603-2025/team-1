...
import Sidebar from './sidebarscad'; // Adjust the path if it's in a different folder
    ...
    <div style={{ display: 'flex' }}>
      ...
      <div style={{
        ...
        style={{
          ...
          marginLeft: menuOpen ? '350px' : '0', // Push content to the right when sidebar is open
        }}
      ></div>
